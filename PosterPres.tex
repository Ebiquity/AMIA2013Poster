...
\author{Vlad Korolev, Anupam Joshi, Yelena Yesha, Michael Grasso}
\date[]{ \today}
\footer{Work in progress \hskip 0.12\textwidth  University of Maryland Baltimore Coounty \hskip 0.05\textwidth University of Marlyand School of Medicine}
...
\item Ensure reproduciblity of experiments and keep track of data provenance
\end{enumerate}
\end{block}
\end{textblock}

\begin{textblock}{23.5}(.2,5.82)
\begin{block}{\center Genetic Causes of Chronic Diseases}
\end{block}
\end{textblock}

\begin{textblock}{6,8}(.2,6.7)
\begin{block}{}
\vskip .25in
...
\begin{columns}
\column{3in}
	\includegraphics[width=4in,height=3in]{StudyPopulationBreakDown.pdf} 	
\column{1in}
\begin{tiny}
\begin{tabular}{l c}
\hline
...
\includegraphics[width=5.75in,height=3in]{CombinedFeatureFrequency.pdf} \hskip .004in
\includegraphics[width=1.2in, height=3in]{FreqTableCombined.png}
...
\begin{columns}
\column{5.75in}
	\includegraphics[width=3in,height=3in]{FeatureFrequencyControls.pdf} 	
	\includegraphics[width=3in,height=3in]{FeatureFrequencyControlsHiPass.pdf} 	
\column{1in}
	\includegraphics[width=1in,height=3in]{FreqTableControls.png}
\end{columns}
...
\begin{columns}
\column{6in}
	\includegraphics[width=3in,height=3in]{FeatureFrequencyCases.pdf} 
	\includegraphics[width=3in,height=3in]{FeatureFrequencyCasesHiPass.pdf} 

\column{1in}
	\includegraphics[width=1in,height=2.75in]{FreqTableCases.png}
\end{columns}
